...
class Sidebar: View {
    ...
    init(items: [Kind: [Any]], onItemClick: OnItemClick?) {
        ...
        contentStackViewEl.insertArrangedSubview(getLibraryItems(), at: 1)
        contentStackViewEl.insertArrangedSubview(getPlaylistsItems(), at: 3)
    }
    ...
    public func updatePlaylists(_ playlists: [PlaylistModel]) {
        ...
        contentStackViewEl.removeArrangedSubview(contentStackViewEl.arrangedSubviews[contentStackViewEl.arrangedSubviews.count - 1])
        contentStackViewEl.insertArrangedSubview(getPlaylistsItems(), at: 3)
    }
}
